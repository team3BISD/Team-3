...
class RewardSystem:
    def __init__(self):
         ...
         Button(window, text = "SIGN UP", width=12, bg='black', fg='white', command = self.confirmationPage).place(x=155, y=650)
    ...
    def confirmationPage(self):
         ...
         Label(window, text = "                             Congratulations, You're earning points!").grid(row = 2, column = 1, sticky = W)
         Label(window, text = "Your Rewards Number").grid(row = 2, column = 1, sticky = W)
         Label(window, text = " ").grid(row = 2, column = 1, sticky = W)
         confirmationPage.mainloop()
