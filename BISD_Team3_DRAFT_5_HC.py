...
class RewardSystem:
    def __init__(self):
         ...
         Button(window, text = "Customer", width=12, bg='White', fg='Black', command = self.customerPage).grid(row = 3, column = 1, sticky = W)
         Button(window, text = "Employee", width=12, bg='White', fg='Black', command = self.employeePage).grid(row = 3, column = 2, sticky = W)
    ...
    def confirmationPage(self):
         ...
         Entry(window, textvariable = self.rewardVar, justify = LEFT).grid(row = 4, column = 2)
